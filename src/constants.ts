...
export const QUESTIONS_BANK: Readonly<Omit<Question, 'originalIndex'>[]> = [
  {
    ...
    choices: ["AI - Artificial Intelligence", "VR - Virtual Reality", "IoT - Internet of Things", "QR - Quick Response"],
  ...
  },
  {
    ...
    choices: ["Cảm biến âm thanh", "Hệ thống trí tuệ cảm xúc nhân tạo", "Bộ điều khiển điện tử", "Kết nối Bluetooth"],
  ...
  },
  {
    ...
    choices: ["Hệ thống quản lý dữ liệu", "Ứng dụng học ngôn ngữ", "Trình duyệt web thông thường", "Trợ lý cá nhân (Personal Assistant)"],
